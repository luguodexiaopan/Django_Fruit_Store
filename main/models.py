...
class shuiguoxinxi(BaseModel):
    ...
    jijie=models.CharField ( max_length=255, null=True, unique=False, verbose_name='季节' )
    ...
    jinghanliang=models.CharField ( max_length=255, null=True, unique=False, verbose_name='净含量' )
    caizhairiqi=models.DateField   (  null=True, unique=False, verbose_name='采摘日期' )
    baozhiqi=models.CharField ( max_length=255, null=True, unique=False, verbose_name='保质期' )
    shuiguojieshao=models.TextField   (  null=True, unique=False, verbose_name='水果介绍' )
...
class cart(BaseModel):
    ...
    addtime = models.DateTimeField(auto_now_add=True, verbose_name=u'创建时间')
    tablename=models.CharField ( max_length=255, null=True, unique=False,default='shuiguoxinxi', verbose_name='商品表名' )
    userid=models.BigIntegerField  ( null=False, unique=False, verbose_name='用户id' )
...
class systemintro(BaseModel):
    ...
    class Meta:
        ...
        verbose_name = verbose_name_plural = '关于我们'
class discussshuiguoxinxi(BaseModel):
    __doc__ = u'''discussshuiguoxinxi'''
    __tablename__ = 'discussshuiguoxinxi'
    ...
    '''
    class Meta:
        db_table = 'discussshuiguoxinxi'
        verbose_name = verbose_name_plural = '水果信息评论表'
